<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="projects.aspx.cs" Inherits="BugTrack.projects" %>
                ...
                <div id="collapse1" class="panel-collapse collapse">
                  <div class="panel-body">
                      <form id="form1" runat="server">
                        ...
                        <div class="form-group col-md-6">
                            <label for="email">Project Language:</label><br />
                            <asp:DropDownList CssClass="form-control" ID="plang" runat="server"
                        ...
                        <div class="form-group col-md-6">
                            <label for="email">Project Base:</label>
                            <asp:TextBox ID="pbase" CssClass="form-control" runat="server"></asp:TextBox>
                        </div>
                        <div class="form-group col-md-6">
                            <br />
